...
const Appliances = () => {
  ...
  const deleteAppliance = (applianceId) => {
    if (window.confirm("Delete Appliance?")) {
      axios
        .delete(`https://repair-or-replace-back-end.onrender.com/api/appliances/${applianceId}/`)
        .then(() => {
          fetchAppliances();
          ...
          {appliancesList.map((appliance) => (
            ...
            >
              <Card style={{ width: "18rem" }}>
                <Card.Img
                  variant="top"
                  src="./../assets/default_home_pic.jpeg"
                />
                <Card.Body>
                  ...
                  <Button variant='danger' onClick={deleteAppliance(appliance.id)}>Delete this Appliance</Button>
                </Card.Body>
              </Card>
            </ListGroup.Item>
          ))}
